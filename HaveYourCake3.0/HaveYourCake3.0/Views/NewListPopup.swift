...
struct NewListPopup: View {
    ...
    private func addNewList() {
        ...
        guard !listTitle.isEmpty, !listItems.isEmpty else {
            print("List title or items cannot be empty.")
            return
        }
...
// MARK: - Preview
struct NewListPopup_Previews: PreviewProvider {
    static var previews: some View {
        NewListPopup(viewModel: HomeViewModel())
    }
}
